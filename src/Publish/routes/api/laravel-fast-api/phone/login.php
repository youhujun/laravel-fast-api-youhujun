 ...
 * @LastEditTime: 2026-04-29 13:44:46
 * @FilePath: \youhu-laravel-api-12\routes\api\laravel-fast-api\phone\login.php
 */
    ...
    Route::prefix('phone')->group(function () {
        Route::namespace('Login')->group(function () {
            ...
            */
            ...
            /**
             * @see \App\Http\Controllers\LaravelFastApi\V1\Phone\Login\AfterLoginController
             */
            Route::controller(AfterLoginController::class)->group(function () {
                //登录获取用户信息
