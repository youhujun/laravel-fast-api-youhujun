 ...
 * @LastEditTime: 2025-02-28 14:03:55
 * @FilePath: \routes\api\laravel-fast-api\phone\notify.php
 */
        ...
        Route::namespace('Notify')->group(function()
        {
            ...
            Route::namespace('Pay')->group(function()
            {
                ...
                Route::namespace('Wechat')->group(function()
                {
                    /**
                     * 微信支付回调
                     * @see \App\Http\Controllers\LaravelFastApi\V1\Phone\Notify\Pay\Wechat\NotifyController
                     */
