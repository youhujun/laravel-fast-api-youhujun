    ...
    Route::prefix('admin')->group(function()
    {
		Route::prefix('login')->group(function()
		{
           ...
           */
			...
			{
				//获取
				Route::any('login','login')->withoutMiddleware('admin.login');
				//开发者登录--开发工作用
				Route::any('loginYouhu','login')->withoutMiddleware('admin.login');
				//退出
		...
		Route::prefix('after-login')->group(function()
		{
			...
			{
				//获取登录用户信息
				Route::any('getAdminInfo','getAdminInfo');

				//获取系统属性路由
				Route::any('getTreePermission','getTreePermission');
