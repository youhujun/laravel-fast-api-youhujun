 ...
 Route::prefix(config('custom.version'))->namespace($namespace)->middleware('admin.login')->group(function()
{
    Route::prefix('admin')->group(function()
    {
        ...
        Route::prefix('system')->namespace('SystemConfig')->group(function()
        {
            ...
            {
                //获取系统配置
                Route::any('getSystemConfig','getSystemConfig');
                //添加系统配置
                Route::any('addSystemConfig','addSystemConfig');
                //更新系统配置
                Route::any('updateSystemConfig','updateSystemConfig');
                //删除系统配置
                Route::any('deleteSystemConfig','deleteSystemConfig');
                // 批量删除
                Route::any('multipleDeleteSystemConfig','multipleDeleteSystemConfig');
            });
            ...
            {
                //获取提示配置
                Route::any('getVoiceConfig','getVoiceConfig');
                //添加提示配置
                Route::any('addVoiceConfig','addVoiceConfig');
                //更新提示配置
                Route::any('updateVoiceConfig','updateVoiceConfig');
                //删除提示配置
                Route::any('deleteVoiceConfig','deleteVoiceConfig');
                // 批量删除
                Route::any('multipleDeleteVoiceConfig','multipleDeleteVoiceConfig');
            });
			...
			Route::namespace('OtherPlatform')->group(function()
			{
				Route::prefix('other-platform')->group(function()
				{
					...
					Route::controller(SystemWechatConfigController::class)->group(function()
					{
						...
						//添加系统微信配置
						Route::any('addSystemWechatConfig','addSystemWechatConfig');
						//修改系统微信配置
						Route::any('updateSystemWechatConfig','updateSystemWechatConfig');
						//删除系统微信配置
						Route::any('deleteSystemWechatConfig','deleteSystemWechatConfig');
						//批量删除系统微信配置
						Route::any('multipleDeleteSystemWechatConfig','multipleDeleteSystemWechatConfig');
					});
					...
					Route::controller(SystemDouyinConfigController::class)->group(function()
					{
						...
						//添加系统抖音配置
						Route::any('addSystemDouyinConfig','addSystemDouyinConfig');
						//修改系统抖音配置
						Route::any('updateSystemDouyinConfig','updateSystemDouyinConfig');
						//删除系统抖音配置
						Route::any('deleteSystemDouyinConfig','deleteSystemDouyinConfig');
						//批量删除系统抖音配置
						Route::any('multipleDeleteSystemDouyinConfig','multipleDeleteSystemDouyinConfig');
					});
				});
			});
        ...
        Route::prefix('role')->namespace('Role')->group(function()
        {
            ...
            */
            ...
            {
                //添加路由
                Route::any('getTreeRole','getTreeRole');
                //更新路由
                Route::any('addRole','addRole');
                //移动菜单
                Route::any('updateRole','updateRole');
                //更新路由
                Route::any('moveRole','moveRole');
                //修改路由状态
                Route::any('deleteRole','deleteRole');
                //修改角色权限
                Route::any('resetRolePermission','resetRolePermission');
        ...
        Route::prefix('region')->namespace('Region')->group(function()
        {
            ...
            */
            ...
            {
                 //获取树形地区
                Route::any('getTreeRegions','getTreeRegion');
                //获取所有地区
                Route::any('getRegions','getAllRegion');
                //添加地区
                Route::any('addRegion','addRegion');
                //更新地区
                Route::any('updateRegion','updateRegion');
                //移动地区
                Route::any('moveRegion','moveRegion');
                //删除地区
                Route::any('deleteRegion','deleteRegion');
        ...
        Route::prefix('bank')->namespace('Bank')->group(function()
        {
            ...
            */
            ...
            {
                //获取常用银行
                Route::any('defaultBank','defaultBank');
                //查找银行
                Route::any('findBank','findBank');
                //获取银行
                Route::any('getBank','getBank');
                //添加银行
                Route::any('addBank','addBank');
                //更新银行
                Route::any('updateBank','updateBank');
                //删除银行
                Route::any('deleteBank','deleteBank');
                //批量删除银行
                Route::any('multipleDeleteBank','multipleDeleteBank');
