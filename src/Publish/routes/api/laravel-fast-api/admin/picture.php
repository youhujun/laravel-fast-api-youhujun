 ...
 Route::prefix(config('custom.version'))->namespace($namespace)->middleware('admin.login')->group(function()
{
    Route::prefix('admin')->group(function()
    {
        ...
        */
        ...
        {
            //获取相册
            Route::any('getAlbum','getAlbum');
            //添加相册
            Route::any('addAlbum','addAlbum');
            //更新相册
            Route::any('updateAlbum','updateAlbum');
            //删除相册
            Route::any('deleteAlbum','deleteAlbum');
            //获取相册图片
            Route::any('getAlbumPicture','getAlbumPicture');

            //获取默认选项
            Route::any('getDefaultAlbum','getDefaultAlbum');
            //查找默认相册
            Route::any('findAlbum','findAlbum');
