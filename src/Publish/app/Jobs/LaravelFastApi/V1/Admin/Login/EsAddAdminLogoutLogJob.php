 ...
 * @Date: 2026-04-26 02:02:54
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-26 02:08:33
 * @FilePath: \youhu-laravel-api-12\app\Jobs\LaravelFastApi\V1\Admin\Login\EsAddAdminLogoutLogJob.php
...
class EsAddAdminLogoutLogJob implements ShouldQueue
{
    use Dispatchable;
    ...
    public function handle(): void
    {
        ...
        if (!isset($esResult) || !isset($esResult['code']) || $esResult['code'] != 0) {
            plog(['error' => 'es添加管理员退出日志失败','$adminLoginLogObject' => $adminLoginLogObject,'$esResult' => $esResult,'$adminObject' => $adminObject], 'EsAddAdminLogoutLogJob', 'handleError');
        }
    }
