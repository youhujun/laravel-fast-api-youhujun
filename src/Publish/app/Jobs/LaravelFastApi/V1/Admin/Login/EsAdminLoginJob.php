 ...
 * @Date: 2026-03-26 06:02:30
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-03-26 06:19:01
 * @FilePath: \youhu-laravel-api-12\app\Jobs\LaravelFastApi\V1\Admin\Login\EsAdminLoginJob.php
...
class EsAdminLoginJob implements ShouldQueue
{
    use Dispatchable;
        ...
        try {
            ...
            if ($adminObject->remember_token) {
                ...
                if (!isset($result['code']) || $result['code'] != 0) {
                    plog(['error' => '更新管理员remember_token失败','result' => $result], 'EsAdminLoginJob', 'AsyncAdminRememberTokenError');
                }
            }
        } catch (\Throwable $th) {
            // em($th, true);
