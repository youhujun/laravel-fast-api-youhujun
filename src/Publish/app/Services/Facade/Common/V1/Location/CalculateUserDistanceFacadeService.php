...
class CalculateUserDistanceFacadeService
{
   public function test()
   {
	...
	public function getUserDistance(User $startUser ,User $endUser)
	{
		...
		$startUserLocationObject = UserLocationLog::where('user_uid',$startUser->id)->orderBy('created_time','desc')->first();
		...
		$endUserLocationObject = UserLocationLog::where('user_uid',$endUser->id)->orderBy('created_time','desc')->first();
