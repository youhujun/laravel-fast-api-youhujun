 ...
 * @LastEditTime: 2026-05-01 04:46:49
 * @FilePath: \youhu-laravel-api-12\app\Services\Facade\Pub\V1\Map\TencentMapFacadeService.php
 */
...
class TencentMapFacadeService
{
     ...
     * 通过H5获取位置信息
     */
    public function getLocationRegionByH5(GetLocationRegionByH5DTO $requestDTO)
    {
