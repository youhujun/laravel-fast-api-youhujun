...
class PhoneLoginDouYinFacadeService
{
        ...
        if ($unionid) {
            ...
            if (!$checkUnionIdResult) {
                ...
                if (!$checkOpenIdResult) {
                    ...
                    $user_uid = $userDouyinUnionidObject->user_uid;
    ...
    */
    protected function bindUserDouyinUnionid($user_uid, $unionid)
    {
        ...
        $userDouyinUnionidObject->user_uid = $user_uid;
    ...
    */
    protected function bindUserDouyinOpenid($user_uid, $openid, $systemDouyinConfigId, $session_key)
    {
        ...
        $userSystemDouyinConfigUnionObject->user_uid = $user_uid;
    ...
    protected function loginUserByOpenid($openid, $systemDouyinConfigId)
    {
        ...
        $userId = $userSystemDouyinConfigUnionObject->user_uid;
        ...
        if ($userObject) {
            ...
            $data['data']['user_uid'] = $userObject->id;
