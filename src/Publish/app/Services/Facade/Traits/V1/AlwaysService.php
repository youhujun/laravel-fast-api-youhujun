 ...
 * @LastEditTime: 2026-04-15 17:00:22
 * @FilePath: \youhu-laravel-api-12\app\Services\Facade\Traits\V1\AlwaysService.php
...
trait AlwaysService
{
     ...
     */
    public function getRecursionChildren($idArray = [], &$idData = [], &$data = null): array
    {
        //先提前查出所有数据
