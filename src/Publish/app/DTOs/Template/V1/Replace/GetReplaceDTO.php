 ...
 * @LastEditTime: 2026-04-01 16:35:42
 * @FilePath: \youhu-laravel-api-12\app\DTOs\Template\V1\Replace\GetReplaceDTO.php
...
class GetReplaceDTO
{
    ...
    {
        return ['currentPage','pageSize','sortType','isExport','exportType','find','findSelectIndex','timeRange',];
    }
