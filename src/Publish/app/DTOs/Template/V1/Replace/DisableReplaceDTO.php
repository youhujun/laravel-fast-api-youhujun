 ...
 * @LastEditTime: 2026-04-01 16:37:43
 * @FilePath: \youhu-laravel-api-12\app\DTOs\Template\V1\Replace\DisableReplaceDTO.php
 ...
 */
class DisableReplaceDTO
{
    use BaseDTOTrait;

    // 禁用用户DTO字段
    public string $replace_uid = '';
    ...
    {
        return ['replace_uid', 'account_status'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['replace_uid', 'account_status'];
