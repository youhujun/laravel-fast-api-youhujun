 ...
 * @Date: 2026-04-01 16:31:31
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-07 17:02:53
 * @FilePath: \youhu-laravel-api-12\app\DTOs\Template\V1\Replace\MultipleDisableReplaceDTO.php
 ...
 */
class MultipleDisableReplaceDTO
{
    use BaseDTOTrait;

    // 批量禁用用户DTO字段
    public array $select_replace_uid_array = [];
    ...
    {
        return ['select_replace_uid_array', 'account_status'];
    }
    ...
    {
        return [
            'select_replace_uid_array' => ['bail', new Required(), new CheckArray()],
            'account_status' => ['bail', new Required(), new Numeric()],
        ];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['select_replace_uid_array', 'account_status'];
