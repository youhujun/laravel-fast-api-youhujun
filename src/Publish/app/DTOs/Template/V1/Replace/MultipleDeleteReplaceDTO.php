 ...
 * @LastEditTime: 2026-04-01 16:35:30
 * @FilePath: \youhu-laravel-api-12\app\DTOs\Template\V1\Replace\MultipleDeleteReplaceDTO.php
 ...
 */
class MultipleDeleteReplaceDTO
{
    use BaseDTOTrait;
    ...
    {
        return ['select_replace_uid_array'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['select_replace_uid_array'];
