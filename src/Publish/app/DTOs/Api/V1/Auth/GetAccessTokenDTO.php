 ...
 * @Date: 2026-02-24 01:27:20
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-02-24 01:31:34
 * @FilePath: \youhu-laravel-api-12\app\DTOs\Api\V1\Auth\GetAccessTokenDTO.php
...
class GetAccessTokenDTO
{
    ...
    {
        return ['timestamp', 'nonce', 'sign','service_flag'];
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'nonce' => ['bail', new Required(), new CheckString()],
            'sign' => ['bail', new Required(), new CheckString()],
            'service_flag' => ['bail', new Required(), new CheckString()],
        ];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['timestamp', 'nonce', 'sign','service_flag'];
    ...
    public function formatFields(): self
    {
        ...
        $this->nonce = trim($this->nonce);
        $this->sign = trim($this->sign);
        $this->service_flag = trim($this->service_flag);
        return $this;
    }
}
