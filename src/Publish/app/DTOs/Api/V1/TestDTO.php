 ...
 * @Date: 2026-03-30 11:04:22
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-03-30 15:51:52
 * @FilePath: \youhu-laravel-api-12\app\DTOs\Api\V1\TestDTO.php
...
class TestDTO
{
    ...
    {
        return ['user_uid', 'params','service_flag'];
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'params' => ['bail', new Required(), new CheckString()],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['user_uid', 'params','service_flag'];
    ...
    public function formatFields(): self
    {
        ...
        $this->user_uid = trim($this->user_uid);
