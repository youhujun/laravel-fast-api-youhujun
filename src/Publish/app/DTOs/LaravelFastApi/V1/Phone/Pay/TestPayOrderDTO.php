 ...
 * @Date: 2026-04-27 02:11:31
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-05-01 21:55:26
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Phone\Pay\TestPayOrderDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Phone\Pay;
...
class TestPayOrderDTO
{
    use BaseDTOTrait;

    // 字段定义（赋默认值）
    public ?string $order_uid = null;
    public ?string $real_pay_amount = null;
    ...
    {
        return ['order_uid', 'real_pay_amount', 'pay_type'];
    }
    ...
    {
        return [
            'order_uid'  => ['bail', 'nullable', new Numeric()],
    ...
    public function validate(array $data): self
    {
        ...
        // 3. 校验字段是否存在（因为都是nullable，所以只需要检查有值的字段即可）
        // 如果需要强制某些字段非空，在这里添加
        // 本接口所有字段都是可选的，无需强制校验
