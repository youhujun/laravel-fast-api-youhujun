 ...
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Phone\User\User\Address\UpdateUserAddressDTO.php
...
class UpdateUserAddressDTO
{
    ...
    {
        return ['id', 'address_type', 'user_name', 'phone', 'region_id_array', 'address_info'];
    }
