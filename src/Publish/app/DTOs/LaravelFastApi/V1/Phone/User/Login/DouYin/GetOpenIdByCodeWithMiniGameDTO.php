 ...
 * @Date: 2026-04-26 19:00:30
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-26 19:01:11
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Phone\User\Login\DouYin\GetOpenIdByCodeWithMiniGameDTO.php
...
class GetOpenIdByCodeWithMiniGameDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public string $appid = '';
    public string $code = '';
    public ?string $anonymousCode = null;
    ...
    {
        return ['appid', 'code', 'anonymousCode'];
    }
    ...
    public function formatFields(): self
    {
        ...
        $this->anonymousCode = $this->anonymousCode ? f($this->anonymousCode) : null;
        return $this;
    }
}