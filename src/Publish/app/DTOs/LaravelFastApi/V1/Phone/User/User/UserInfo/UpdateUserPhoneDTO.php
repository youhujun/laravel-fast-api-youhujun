 ...
 * @Date: 2026-04-27 03:55:42
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-27 04:00:02
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Phone\User\User\UserInfo\UpdateUserPhoneDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Phone\User\User\UserInfo;
...
class UpdateUserPhoneDTO
{
    ...
    public function rules(): array
    {
        ...
        return [
            'phone' => ['bail', new Required(), new Phone(),new CheckUnique('users', 'phone', 'user', 'user_uid', $userObject->user_uid)],
        ];
    }
