<?php
/*
 * @Description: 抖音小程序登录注册
 * @version: v1
 * @Author: youhujun youhu8888@163.com & xueer
 * @Date: 2026-04-26 19:05:00
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-26 19:05:00
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Phone\User\Login\DouYin\LoginAndRegisterWithMiniProgramDTO.php
...
class LoginAndRegisterWithMiniProgramDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public string $ip = '';
