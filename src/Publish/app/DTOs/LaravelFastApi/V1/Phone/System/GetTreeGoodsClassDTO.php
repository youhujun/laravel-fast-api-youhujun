 ...
 * @Date: 2026-04-27 02:34:39
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-27 02:45:00
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Phone\System\GetTreeGoodsClassDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Phone\System;
...
class GetTreeGoodsClassDTO
{
    ...
    public function validate(array $data): self
    {
        ...
        // 3. 校验字段是否存在（控制器里有额外校验：if (!isset($validated['find']))）
        // Required规则已确保find存在，但为保持与控制器一致，这里额外检查
