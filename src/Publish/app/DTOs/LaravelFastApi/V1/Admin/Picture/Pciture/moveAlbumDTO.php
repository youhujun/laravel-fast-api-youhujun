 ...
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Picture\Pciture\moveAlbumDTO.php
...
class moveAlbumDTO
{
    ...
    public function validate(array $data): self
    {
        ...
        // 校验必填字段
        $requiredFields = ['album_uid', 'picture_uid'];
