 ...
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Picture\Album\AddAlbumDTO.php
...
class AddAlbumDTO
{
    ...
    {
        return ['album_type', 'album_name', 'album_description', 'sort'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        // 校验必填字段
        $requiredFields = ['album_type', 'album_name', 'sort'];
