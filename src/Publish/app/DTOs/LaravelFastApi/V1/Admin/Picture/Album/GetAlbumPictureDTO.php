 ...
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Picture\Album\GetAlbumPictureDTO.php
...
class GetAlbumPictureDTO
{
    ...
    {
        return ['album_uid', 'sortType', 'currentPage', 'pageSize'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        // 校验必填字段
        $requiredFields = ['album_uid', 'sortType'];
