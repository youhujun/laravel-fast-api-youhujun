 ...
 * @Date: 2026-04-07 12:24:36
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-07 12:35:47
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\User\RealAuth\RealAuthUserDTO.php
 ...
 */
class RealAuthUserDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public int $user_real_auth_log_uid = 0;
    public int $user_uid = 0;
    public int $is_real_auth = 0;
    ...
    {
        return ['user_real_auth_log_uid', 'user_uid', 'is_real_auth', 'refuse_info'];
    }
    ...
    {
        return [
            'user_real_auth_log_uid' => ['bail', new Required(), new Numeric()],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['user_real_auth_log_uid', 'user_uid', 'is_real_auth'];
