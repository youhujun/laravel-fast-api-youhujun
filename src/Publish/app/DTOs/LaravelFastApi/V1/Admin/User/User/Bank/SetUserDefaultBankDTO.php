 ...
 * @Date: 2026-04-06 04:26:17
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-06 04:28:00
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\User\Bank\SetUserDefaultBankDTO.php
 ...
 */
class SetUserDefaultBankDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public int $user_bank_uid = 0;
    ...
    {
        return [
            'user_bank_uid' => ['bail', new Required(), new Numeric()],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['user_uid', 'user_bank_uid'];
