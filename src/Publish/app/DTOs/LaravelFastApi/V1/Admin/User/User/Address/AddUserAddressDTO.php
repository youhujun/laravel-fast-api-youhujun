 ...
 * @Date: 2026-04-06 03:54:48
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-06 03:59:12
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\User\Address\AddUserAddressDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\User\User\Address;
...
class AddUserAddressDTO
{
    ...
    {
        return ['user_uid', 'user_name', 'phone', 'is_default', 'address_type', 'regionArray', 'address_info'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['user_uid', 'address_type', 'regionArray', 'address_info', 'is_default'];
