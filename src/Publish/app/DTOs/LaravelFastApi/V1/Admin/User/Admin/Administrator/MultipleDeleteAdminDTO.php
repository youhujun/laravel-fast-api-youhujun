 ...
 * @LastEditTime: 2026-05-19 01:45:37
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\Admin\Administrator\MultipleDeleteAdminDTO.php
...
class MultipleDeleteAdminDTO
{
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['select_uid_array'];
