 ...
 * @Date: 2026-04-07 03:58:26
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-07 04:34:26
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\User\Details\UpdateUserPhoneDTO.php
...
class UpdateUserPhoneDTO
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone' => ['bail', new Required(), new CheckUnique('users', 'phone', 'user', $this->user_uid)],
        ];
    }
