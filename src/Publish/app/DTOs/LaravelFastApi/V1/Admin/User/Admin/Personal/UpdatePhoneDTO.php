 ...
 * @Date: 2026-04-07 15:51:16
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-07 15:59:41
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\Admin\Personal\UpdatePhoneDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\User\Admin\Personal;
...
class UpdatePhoneDTO
{
    ...
    {
        return [
            'phone' => ['bail', new Required(), new Phone(), new CheckUnique('admins', 'phone', 'user')],
        ];
    }
