 ...
 * @Date: 2026-04-07 12:25:41
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-13 12:33:30
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\User\RealAuth\SetUserIdCardDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\User\User\RealAuth;
 ...
 */
class SetUserIdCardDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public int $user_uid = 0;
    public int $id_card_front_uid = 0;
    public int $id_card_back_uid = 0;
    ...
    {
        return ['user_uid', 'id_card_front_uid', 'id_card_back_uid','id_number', 'sort'];
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'id_card_front_uid' => ['bail', 'nullable', new Numeric()],
            'id_card_back_uid' => ['bail', 'nullable', new Numeric()],
            'id_number' => ['bail', new Required(), new CheckString()],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['user_uid','id_number'];
