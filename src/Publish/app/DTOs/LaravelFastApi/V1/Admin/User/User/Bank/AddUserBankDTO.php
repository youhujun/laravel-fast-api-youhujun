 ...
 * @Date: 2026-04-06 04:25:48
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-06 04:28:07
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\User\Bank\AddUserBankDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\User\User\Bank;
...
class AddUserBankDTO
{
    ...
    //银行卡正面
    public ?int $bank_front_uid = null;
    //银行卡背面
    public ?int $bank_back_uid = null;
    //是否默认
    ...
    {
        return ['user_uid', 'bank_id', 'bank_number', 'bank_account', 'bank_address', 'bank_front_uid', 'bank_back_uid', 'is_default', 'sort'];
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'bank_number' => ['bail', new Required(), new Numeric()],
            'bank_account' => ['bail', new Required(), new CheckString()],
            'bank_address' => ['bail', 'nullable', new CheckString()],
            'bank_front_uid' => ['bail', 'nullable', new Numeric()],
            'bank_back_uid' => ['bail', 'nullable', new Numeric()],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['user_uid', 'bank_id', 'bank_number', 'bank_account'];
