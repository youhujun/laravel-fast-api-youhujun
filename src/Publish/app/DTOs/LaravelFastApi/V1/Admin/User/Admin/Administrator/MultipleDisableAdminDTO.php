 ...
 * @LastEditTime: 2026-05-19 01:47:21
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\Admin\Administrator\MultipleDisableAdminDTO.php
...
class MultipleDisableAdminDTO
{
    ...
    {
        return ['select_uid_array','account_status'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['select_uid_array','account_status'];
