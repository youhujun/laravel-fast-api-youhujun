 ...
 * @LastEditTime: 2026-04-07 14:37:48
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\Admin\Administrator\GetDefaultAdminDTO.php
...
class DisableAdminDTO
{
    ...
    {
        return ['admin_uid', 'account_status'];
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'account_status' => [new Required(), new Numeric()],
        ];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['admin_uid', 'account_status'];
