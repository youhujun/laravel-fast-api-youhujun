 ...
 * @LastEditTime: 2026-04-07 14:45:10
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\Admin\Administrator\GetAdminDTO.php
...
class GetAdminDTO
{
    ...
    {
        return ['find', 'findSelectIndex', 'timeRange', 'account_status', 'sortType', 'currentPage', 'pageSize', 'isExport', 'exportType'];
    }
