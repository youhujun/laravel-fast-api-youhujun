 ...
 * @LastEditTime: 2026-05-17 21:44:12
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\Admin\Administrator\AddAdminDTO.php
...
class AddAdminDTO
{
    ...
    {
        return ['user_uid', 'phone', 'role_cascader_id_array'];
    }
    ...
    {
        return [
            'user_uid' => ['bail', new Required(), new Numeric(), new CheckUnique('admins', 'user_uid', 'user')],
            'phone' => ['bail', new Required(), new CheckString(), new Phone(), new CheckUnique('admins', 'phone', 'user')],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['user_uid', 'phone','role_cascader_id_array'];
