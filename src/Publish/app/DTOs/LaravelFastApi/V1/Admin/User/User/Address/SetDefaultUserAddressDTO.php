 ...
 * @Date: 2026-04-06 03:55:50
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-06 04:20:39
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\User\Address\SetDefaultUserAddressDTO.php
 ...
 */
class SetDefaultUserAddressDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public int $user_address_uid = 0;
    ...
    {
        return ['user_address_uid', 'user_uid'];
    }
    ...
    {
        return [
            'user_address_uid' => ['bail', new Required(), new Numeric()],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['user_address_uid', 'user_uid'];
