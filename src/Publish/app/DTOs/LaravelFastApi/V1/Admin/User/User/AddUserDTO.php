 ...
 * @LastEditTime: 2026-03-27 14:59:09
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\User\AddUserDTO.php
...
class AddUserDTO
{
    ...
    // 添加用户DTO字段
    public ?string $source_user_uid = null;
    public string $phone = '';
    ...
    {
        return ['source_user_uid', 'phone', 'password', 'nick_name', 'sex'];
    }
    ...
    {
        return [
            'source_user_uid' => ['bail', 'nullable', new Numeric()],
            'phone' => ['bail', new Required(), new CheckString(), new Phone(), new CheckUnique('users', 'phone','user')],
