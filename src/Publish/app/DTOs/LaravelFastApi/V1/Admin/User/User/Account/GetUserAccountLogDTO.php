 ...
 * @Date: 2026-04-06 03:14:11
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-06 03:15:26
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\User\Account\GetUserAccountLogDTO.php
...
class GetUserAccountLogDTO
{
    ...
    {
        return ['timeRange', 'currentPage', 'pageSize', 'sortType', 'user_uid', 'account_type', 'action_type'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['sortType', 'user_uid', 'account_type', 'action_type'];
