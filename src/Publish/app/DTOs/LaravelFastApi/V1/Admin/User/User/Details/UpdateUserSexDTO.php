 ...
 * @Date: 2026-04-07 03:59:13
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-07 04:34:53
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\User\Details\UpdateUserSexDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\User\User\Details;
...
class UpdateUserSexDTO
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sex' => ['bail', 'nullable', new Numeric(), new \App\Rules\LaravelFastApi\V1\Admin\User\User\CheckSex()],
        ];
    }
