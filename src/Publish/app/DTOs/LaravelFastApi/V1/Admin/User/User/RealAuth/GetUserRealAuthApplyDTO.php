 ...
 * @Date: 2026-04-07 12:23:53
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-07 12:34:42
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\User\RealAuth\GetUserRealAuthApplyDTO.php
...
class GetUserRealAuthApplyDTO
{
    ...
    {
        return ['user_uid', 'currentPage', 'pageSize', 'sortType'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['user_uid', 'sortType'];
