 ...
 * @Date: 2026-04-06 03:13:45
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-06 03:15:12
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\User\User\Account\SetUserAccountDTO.php
...
class SetUserAccountDTO
{
    ...
    {
        return ['user_uid', 'account_type', 'action_type', 'amount'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['user_uid', 'account_type', 'action_type', 'amount'];
    ...
    public function formatFields(): self
    {
		...
		$this->amount = bcmul($this->amount,100);
