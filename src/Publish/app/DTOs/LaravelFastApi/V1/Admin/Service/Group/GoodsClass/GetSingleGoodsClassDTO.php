 ...
 * @LastEditTime: 2026-04-08 13:36:04
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Group\GoodsClass\GetSingleGoodsClassDTO.php
 ...
 */
class GetSingleGoodsClassDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public int $goods_class_id = 0;
