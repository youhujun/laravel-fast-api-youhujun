 ...
 * @LastEditTime: 2026-04-08 21:34:44
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Level\UserLevel\UpdateUserLevelItemUnionDTO.php
 ...
 */
class UpdateUserLevelItemUnionDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public string $id = '';
    ...
    {
        return ['id', 'sort', 'user_level_id', 'level_item_id', 'value', 'value_type'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['id', 'sort', 'user_level_id', 'level_item_id', 'value', 'value_type'];
