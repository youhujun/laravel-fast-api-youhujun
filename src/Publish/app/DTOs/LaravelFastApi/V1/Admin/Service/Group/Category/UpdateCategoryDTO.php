 ...
 * @Date: 2026-04-08 07:52:38
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-05-09 01:43:44
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Group\Category\UpdateCategoryDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\Service\Group\Category;
...
class UpdateCategoryDTO
{
    ...
    public ?string $category_picture_uid = null;
    ...
    public function rules(): array
    {
        return [
            ...
            'category_code' => ['bail', new Required(), new CheckString(), new CheckBetween(2, 30), new LetterNumberUnderLine(), new CheckDbUnique('article_categories', 'category_code', $this->ignore_id)],
            'note' => ['bail', 'nullable', new CheckString(), new CheckBetween(0, 30), new ChineseCodeNumberLine()],
            'category_picture_uid' => ['bail', 'nullable', new Numeric()],
        ];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['id', 'parent_id', 'sort', 'rate', 'category_name', 'category_code'];
