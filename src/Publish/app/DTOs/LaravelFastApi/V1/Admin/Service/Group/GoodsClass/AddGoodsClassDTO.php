 ...
 * @LastEditTime: 2026-04-08 13:36:10
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Group\GoodsClass\AddGoodsClassDTO.php
...
class AddGoodsClassDTO
{
    ...
    {
        return ['parent_id', 'deep', 'sort', 'rate', 'goods_class_name', 'goods_class_code', 'is_certificate', 'certificate_number', 'note', 'goods_class_picture_uid'];
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'goods_class_code' => ['bail', 'nullable', new CheckString(), new CheckBetween(2, 30), new CheckDbUnique('goods_classes', 'goods_class_code')],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['parent_id', 'deep', 'goods_class_name'];
