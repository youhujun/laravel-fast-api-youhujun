 ...
 * @Date: 2026-04-08 07:57:51
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-05-09 16:17:42
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Level\LevelItem\UpdateLevelItemDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\Service\Level\LevelItem;
...
class UpdateLevelItemDTO
{
    ...
    public function rules(): array
    {
        return [
            ...
            'item_name' => ['bail', new Required(), new CheckString(), new CheckBetween(1, 30), new ChineseCodeNumberLine(), new CheckDbUnique('level_items', 'item_name',  $this->ignore_id)],
            'item_code' => ['bail', new Required(), new CheckString(), new CheckBetween(1, 30), new ChineseCodeNumberLine(), new CheckDbUnique('level_items', 'item_code',  $this->ignore_id)],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['id', 'sort', 'type', 'item_name', 'item_code'];
