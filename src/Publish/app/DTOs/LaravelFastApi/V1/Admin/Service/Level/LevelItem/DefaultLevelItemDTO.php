 ...
 * @LastEditTime: 2026-04-08 13:38:00
...
/**
 * @see \App\HttpControllers\LaravelFastApi\V1\Admin\Service\Level\LevelItemController
 */
class DefaultLevelItemDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    ...
    public function validate(array $data): self
    {
        ...
        // DefaultLevelItemDTO 无必填字段，无需校验
        $requiredFields = [];
