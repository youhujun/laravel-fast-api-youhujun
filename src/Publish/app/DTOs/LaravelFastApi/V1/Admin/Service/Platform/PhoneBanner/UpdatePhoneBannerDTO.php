 ...
 * @Date: 2026-04-08 08:05:49
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-08 21:46:29
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Platform\PhoneBanner\UpdatePhoneBannerDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */
namespace App\DTOs\LaravelFastApi\V1\Admin\Service\Platform\PhoneBanner;
 ...
 */
class UpdatePhoneBannerDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public string $id = '';
    public string $album_picture_uid = '';
    ...
    {
        return ['id', 'album_picture_uid', 'redirect_url', 'note', 'sort'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['id', 'album_picture_uid', 'sort'];
