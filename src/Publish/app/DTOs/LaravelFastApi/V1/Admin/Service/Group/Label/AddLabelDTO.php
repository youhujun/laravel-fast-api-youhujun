 ...
 * @LastEditTime: 2026-04-08 13:36:41
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Group\Label\AddLabelDTO.php
...
class AddLabelDTO
{
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['parent_id', 'deep', 'sort', 'label_name'];
