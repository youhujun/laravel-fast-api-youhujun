 ...
 * @LastEditTime: 2026-04-08 13:35:43
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Group\Category\AddCategoryDTO.php
...
class AddCategoryDTO
{
    ...
    public function rules(): array
    {
        return [
            ...
            'category_code' => ['bail', new Required(), new CheckString(), new CheckBetween(2, 30), new LetterNumberUnderLine(), new CheckDbUnique('article_categories', 'category_code')],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['parent_id', 'deep', 'sort', 'rate', 'category_name', 'category_code'];
