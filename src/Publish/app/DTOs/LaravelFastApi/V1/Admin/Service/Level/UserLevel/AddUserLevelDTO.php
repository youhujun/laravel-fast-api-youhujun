 ...
 * @LastEditTime: 2026-04-08 13:38:39
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Level\UserLevel\AddUserLevelDTO.php
...
class AddUserLevelDTO
{
    ...
    public ?int $background_picture_uid = 0;
    ...
    {
        return ['sort', 'level_name', 'level_code', 'amount', 'background_picture_uid', 'note'];
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'level_name' => ['bail', new Required(), new CheckString(), new CheckBetween(1, 30), new ChineseCodeNumberLine(), new CheckDbUnique('user_levels', 'level_name')],
            'level_code' => ['bail', new Required(), new CheckString(), new CheckBetween(1, 30), new ChineseCodeNumberLine(), new CheckDbUnique('user_levels', 'level_code')],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['sort', 'level_name', 'level_code'];
