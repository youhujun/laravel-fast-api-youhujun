 ...
 * @Date: 2026-04-08 07:50:06
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-05-09 12:33:11
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Group\GoodsClass\UpdateGoodsClassDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */
namespace App\DTOs\LaravelFastApi\V1\Admin\Service\Group\GoodsClass;
...
class UpdateGoodsClassDTO
{
    ...
    public int $is_certificate = 0;
    public int $certificate_number = 0;
    public string $note = '';
    public int $goods_class_picture_uid = 0;
    ...
    {
        return ['id', 'parent_id', 'deep', 'sort', 'rate', 'goods_class_name', 'goods_class_code', 'is_certificate', 'certificate_number', 'note', 'goods_class_picture_uid'];
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'goods_class_code' => ['bail', 'nullable', new CheckString(), new CheckBetween(2, 30), new CheckDbUnique('goods_classes', 'goods_class_code', $this->ignore_id)],
            ...
            'goods_class_picture_uid' => ['bail', 'nullable', new Numeric()],
        ];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['id', 'parent_id', 'deep', 'goods_class_name'];
