 ...
 * @Date: 2026-04-08 08:09:45
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-08 13:39:40
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Platform\PhoneBanner\Details\UpdatePhoneBannerBakInfoDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */
namespace App\DTOs\LaravelFastApi\V1\Admin\Service\Platform\PhoneBanner\Details;
...
class UpdatePhoneBannerPictureDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public int|string $id = '';
    public int|string $album_picture_uid = '';
    ...
    public function rules(): array
    {
        return [
            ...
            'album_picture_uid' => ['bail', new Required(), new Numeric()],
        ];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['id', 'album_picture_uid'];
