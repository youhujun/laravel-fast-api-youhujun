 ...
 * @LastEditTime: 2026-04-08 13:40:07
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Platform\PhoneBanner\AddPhoneBannerDTO.php
...
class AddPhoneBannerDTO
{
    ...
    {
        return ['album_picture_uid', 'redirect_url', 'note', 'sort'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['album_picture_uid', 'sort'];
