 ...
 * @LastEditTime: 2026-04-08 21:17:51
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Level\LevelItem\AddLevelItemDTO.php
...
class AddLevelItemDTO
{
    ...
    public function rules(): array
    {
        return [
            ...
            'item_name' => ['bail', new Required(), new CheckString(), new CheckBetween(1, 30), new ChineseCodeNumberLine(), new CheckDbUnique('level_items', 'item_name')],
            'item_code' => ['bail', new Required(), new CheckString(), new CheckBetween(1, 30), new ChineseCodeNumberLine(), new CheckDbUnique('level_items', 'item_code')],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['sort', 'type', 'item_name', 'item_code'];
