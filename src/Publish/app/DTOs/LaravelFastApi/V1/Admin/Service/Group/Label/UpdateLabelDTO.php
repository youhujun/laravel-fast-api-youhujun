 ...
 * @Date: 2026-04-08 07:54:25
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-08 22:54:50
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Service\Group\Label\UpdateLabelDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\Service\Group\Label;
...
class UpdateLabelDTO
{
    ...
    public ?string $label_code = null;
    public ?string $note = null;
    public ?string $label_picture_uid = null;
    ...
    public function rules(): array
    {
        return [
            ...
            'label_picture_uid' => ['bail', 'nullable', new Numeric()],
        ];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['id', 'parent_id', 'deep', 'sort', 'label_name'];
