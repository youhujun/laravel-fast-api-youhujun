 ...
 * @LastEditTime: 2026-05-04 22:55:49
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\SystemConfig\SystemConfig\GetSystemConfigDTO.php
...
class GetSystemConfigDTO
{
    ...
    {
        return ['find', 'findSelectIndex', 'timeRange', 'currentPage', 'pageSize', 'sortType'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['sortType','currentPage','pageSize'];
