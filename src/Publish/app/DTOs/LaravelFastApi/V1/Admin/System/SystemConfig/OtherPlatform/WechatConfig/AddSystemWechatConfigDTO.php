 ...
 * @Date: 2026-04-08 07:32:15
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-08 13:30:23
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\SystemConfig\OtherPlatform\WechatConfig\AddSystemWechatConfigDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\System\SystemConfig\OtherPlatform\WechatConfig;
 ...
 */
class AddSystemWechatConfigDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    ...
    {
        return ['name', 'type', 'sort', 'appid', 'appsecret', 'note'];
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'appid' => ['bail', new Required(), new CheckString(), new CheckDbUnique('system_wechat_configs', 'appid')],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['type', 'appid', 'appsecret'];
