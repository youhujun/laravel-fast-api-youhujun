 ...
 * @Date: 2026-04-08 05:50:08
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-08 05:53:30
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\SystemConfig\VoiceConfig\AddVoiceConfigDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\System\SystemConfig\VoiceConfig;
 ...
 */
class AddVoiceConfigDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public string $voice_title = '';
    public string $channle_name = '';
    public string $channle_event = '';
    public int $voice_save_type = 0;
    ...
    {
        return ['voice_title', 'channle_name', 'channle_event', 'voice_save_type', 'voice_url', 'voice_path', 'note'];
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'channle_event' => ['bail', new Required(), new CheckString(), new CheckDbUnique('system_voice_configs', 'channle_event')],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['voice_title', 'channle_name', 'channle_event', 'voice_save_type', 'note'];
