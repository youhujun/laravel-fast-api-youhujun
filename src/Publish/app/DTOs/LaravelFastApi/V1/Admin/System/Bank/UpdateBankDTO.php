 ...
 * @Date: 2026-04-08 07:44:40
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-08 13:35:06
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\Bank\UpdateBankDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\System\Bank;
...
class UpdateBankDTO
{
    ...
    {
        return ['id', 'bank_name', 'bank_code', 'is_default', 'sort'];
    }
    ...
    {
        $id = check_id(request()->input('id', 0));
        return [
            'id' => ['bail', new Required(), new Numeric()],
            'bank_name' => ['bail', new Required(), new ChineseCodeNumberLine(), new CheckDbUnique('banks', 'bank_name', $id)],
            'bank_code' => ['nullable', new CheckDbUnique('banks', 'bank_code', $id)],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['id', 'bank_name', 'is_default', 'sort'];
