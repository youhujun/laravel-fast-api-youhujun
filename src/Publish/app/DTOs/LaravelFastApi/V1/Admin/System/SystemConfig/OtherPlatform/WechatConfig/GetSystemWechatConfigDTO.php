 ...
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\SystemConfig\OtherPlatform\WechatConfig\GetSystemWechatConfigDTO.php
 ...
 */
class GetSystemWechatConfigDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    ...
    public function formatFields(): self
    {
        ...
        // int 字段保持原类型，不进行 f() 处理
        // findSelectIndex, currentPage, pageSize, sortType, type 已经是 int 类型
