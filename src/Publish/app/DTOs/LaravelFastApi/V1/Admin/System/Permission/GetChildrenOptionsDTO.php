 ...
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\Permission\GetChildrenOptionsDTO.php
 ...
 */
class GetChildrenOptionsDTO
{
    use BaseDTOTrait;

    // 字段定义 - 严格按控制器验证规则
    public int $onlyParent = 0;
