 ...
 * @LastEditTime: 2026-04-08 13:34:40
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\Bank\GetBankDTO.php
...
class GetBankDTO
{
    ...
    {
        return ['find', 'findSelectIndex', 'timeRange', 'switch', 'sortType', 'currentPage', 'pageSize', 'isExport', 'exportType', 'status'];
    }
