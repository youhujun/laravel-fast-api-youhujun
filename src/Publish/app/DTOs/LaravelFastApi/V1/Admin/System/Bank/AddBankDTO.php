 ...
 * @LastEditTime: 2026-04-08 17:02:49
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\Bank\AddBankDTO.php
...
class AddBankDTO
{
    ...
    {
        return ['bank_name', 'bank_code', 'is_default', 'sort'];
    }
    ...
    {
        return [
            'bank_name' => ['bail', new Required(), new ChineseCodeNumberLine(), new CheckDbUnique('banks', 'bank_name')],
            'bank_code' => ['nullable', new CheckDbUnique('banks', 'bank_code')],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['bank_name', 'is_default', 'sort'];
