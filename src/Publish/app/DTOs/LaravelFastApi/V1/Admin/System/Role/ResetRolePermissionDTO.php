 ...
 * @LastEditTime: 2026-04-08 13:31:31
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\Role\ResetRolePermissionDTO.php
 ...
 */
class ResetRolePermissionDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public int $role_id = 0;
    public ?array $before_permission = null;
    public ?array $after_permission = null;
    ...
    {
        return ['role_id', 'before_permission', 'after_permission'];
    }
