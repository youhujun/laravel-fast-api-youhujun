 ...
 * @LastEditTime: 2026-05-06 13:00:03
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\Role\UpdateRoleDTO.php
...
class UpdateRoleDTO
{
    ...
    {
        return ['id', 'sort', 'role_name', 'logic_name','type','is_system'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['id', 'sort', 'role_name', 'logic_name','type','is_system'];
