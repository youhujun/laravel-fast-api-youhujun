 ...
 * @LastEditTime: 2026-04-08 14:41:56
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\SystemConfig\OtherPlatform\WechatConfig\UpdateSystemWechatConfigDTO.php
 ...
 */
class UpdateSystemWechatConfigDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public int $id = 0;
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'appid' => ['bail', new Required(), new CheckString(), new CheckDbUnique('system_wechat_configs', 'appid', $id)],
