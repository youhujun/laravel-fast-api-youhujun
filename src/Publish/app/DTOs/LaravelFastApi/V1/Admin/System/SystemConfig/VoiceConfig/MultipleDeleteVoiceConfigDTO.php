 ...
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\SystemConfig\VoiceConfig\MultipleDeleteVoiceConfigDTO.php
 ...
 */
class MultipleDeleteVoiceConfigDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
