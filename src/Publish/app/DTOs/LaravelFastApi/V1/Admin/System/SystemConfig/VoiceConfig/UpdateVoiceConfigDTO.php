 ...
 * @LastEditTime: 2026-04-08 06:41:00
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\SystemConfig\VoiceConfig\UpdateVoiceConfigDTO.php
...
class UpdateVoiceConfigDTO
{
    ...
    {
        return ['id', 'voice_title', 'channle_name', 'channle_event', 'voice_save_type', 'voice_url', 'voice_path', 'note'];
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'channle_event' => ['bail', new Required(), new CheckString(), new CheckDbUnique('system_voice_configs', 'channle_event', $id)],
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['id', 'voice_title', 'channle_name', 'channle_event', 'voice_save_type', 'note'];
