 ...
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\SystemConfig\SystemConfig\MultipleDeleteSystemConfigDTO.php
 ...
 */
class MultipleDeleteSystemConfigDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['select_id_array'];
