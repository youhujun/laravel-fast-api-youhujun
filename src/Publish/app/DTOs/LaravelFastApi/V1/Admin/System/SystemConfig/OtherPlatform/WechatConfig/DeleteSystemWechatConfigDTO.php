 ...
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\SystemConfig\OtherPlatform\WechatConfig\DeleteSystemWechatConfigDTO.php
 ...
 */
class DeleteSystemWechatConfigDTO
{
    use BaseDTOTrait;
    // 字段定义（赋默认值）
    public int $id = 0;
