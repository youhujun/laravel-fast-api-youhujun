 ...
 * @Date: 2026-04-08 07:41:37
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-08 13:32:36
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\System\Region\UpdateRegionDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\System\Region;
...
class UpdateRegionDTO
{
    ...
    {
        return ['id', 'parent_id', 'deep', 'sort', 'region_name'];
    }
    ...
    {
        // 字符串字段使用 f() 过滤
        $this->region_name = f($this->region_name);
