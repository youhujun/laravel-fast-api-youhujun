 ...
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Article\Article\ToTopArticleDTO.php
...
class ToTopArticleDTO
{
    ...
    public function validate(array $data): self
    {
        ...
        // 校验必填字段
        if (!isset($validated['article_uid'])) {
            throw new RuleException('RuleRequiredError', 'article_uid');
        }
