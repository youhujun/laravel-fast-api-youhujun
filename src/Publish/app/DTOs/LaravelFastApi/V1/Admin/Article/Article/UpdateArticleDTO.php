 ...
 * @LastEditTime: 2026-05-21 20:57:15
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Article\Article\UpdateArticleDTO.php
...
class UpdateArticleDTO
{
    ...
    {
        return ['article_uid', 'type', 'title', 'category_cascader_id_array', 'label_cascader_id_array', 'is_top', 'content', 'published_time', 'sort'];
    }
    ...
    {
        return [
            'article_uid' => ['bail', new Required(), new Numeric()],
    ...
    public function validate(array $data): self
    {
        ...
        // 校验必填字段
        $requiredFields = ['article_uid', 'type', 'title', 'category_cascader_id_array', 'content'];
