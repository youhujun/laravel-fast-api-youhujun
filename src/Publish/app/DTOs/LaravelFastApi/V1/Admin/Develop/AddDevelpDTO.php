 ...
 * @Date: 2026-04-02 01:47:45
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-02 03:17:54
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Develop\AddDevelpDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\Develop;
...
class AddDevelpDTO
{
    ...
    {
        return [
            'username' => ['bail','nullable',new Required(),new CheckString(),new CheckBetween(1, 20),new CheckUnique('users', 'account_name', 'user')],
