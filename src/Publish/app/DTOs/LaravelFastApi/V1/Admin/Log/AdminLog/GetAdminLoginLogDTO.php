 ...
 * @LastEditTime: 2026-04-25 23:16:54
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Log\AdminLog\GetAdminLoginLogDTO.php
...
class GetAdminLoginLogDTO
{
    ...
    {
        return ['$admin_uid', 'timeRange', 'status', 'sortType', 'currentPage', 'pageSize'];
    }
