 ...
 * @LastEditTime: 2026-04-26 05:29:45
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\Log\UserLog\GetUserLoginLogDTO.php
...
class GetUserLoginLogDTO
{
    ...
    {
        return ['user_uid', 'timeRange', 'status', 'sortType', 'currentPage', 'pageSize'];
    }
