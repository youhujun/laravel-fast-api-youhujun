 ...
 * @LastEditTime: 2026-05-14 18:54:25
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\File\UploadUserAvatarDTO.php
...
class UploadUserAvatarDTO
{
    ...
    {
        return ['album_uid', 'user_uid', 'picture_uid', 'use_type','file_type','save_path'];
    }
    ...
    public function validate(array $data): self
    {
        ...
        $requiredFields = ['user_uid', 'use_type'];
