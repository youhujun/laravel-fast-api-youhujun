 ...
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\File\UploadMultiplePicutureDTO.php
...
class UploadMultiplePicutureDTO
{
    use BaseDTOTrait;
    //相册uid
    ...
    {
        return ['album_uid', 'use_type','file_type','save_path'];
    }
