 ...
 * @Date: 2026-04-04 12:22:45
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-04-04 12:50:00
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\File\UploadResetPictureDTO.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\DTOs\LaravelFastApi\V1\Admin\File;
...
class UploadResetPictureDTO
{
    ...
    {
        return ['album_uid', 'picture_uid', 'use_type','file_type','save_path'];
    }
    ...
    {
        return [
            'album_uid' => ['bail','nullable',new Numeric()],
            //图片id 替换上传是传入 可以为0
            'picture_uid' => ['bail','nullable',new Numeric()],
            //使用类型 10系统配置 20管理员 30后台
