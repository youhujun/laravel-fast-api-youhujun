 ...
 * @LastEditTime: 2026-04-04 12:47:46
 * @FilePath: \youhu-laravel-api-12\app\DTOs\LaravelFastApi\V1\Admin\File\UploadConfigFileDTO.php
...
class UploadConfigFileDTO
{
    ...
    {
        return ['type', 'use_type','file_type','save_path'];
    }
