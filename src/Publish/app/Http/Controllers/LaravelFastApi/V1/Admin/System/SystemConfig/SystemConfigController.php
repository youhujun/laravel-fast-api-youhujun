 ...
 * @LastEditTime: 2025-12-19 21:56:57
 * @FilePath: \app\Http\Controllers\LaravelFastApi\V1\Admin\System\SystemConfig\SystemConfigController.php
 */
    ...
    public function getSystemConfig(Request $request)
    {
        ...
        if(Gate::forUser($admin)->allows('admin-role'))
        {
            ...
            if (!isset($validated['item_type'])) {
                throw new RuleException('RuleRequiredError', 'item_type');
            }
