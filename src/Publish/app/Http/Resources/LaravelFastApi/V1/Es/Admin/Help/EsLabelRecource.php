 ...
 * @Date: 2026-04-20 08:50:49
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-05-09 13:48:08
 * @FilePath: \youhu-laravel-api-12\app\Http\Resources\LaravelFastApi\V1\Es\Admin\Help\EsLabelRecource.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\Http\Resources\LaravelFastApi\V1\Es\Admin\Help;

use Illuminate\Http\Resources\Json\JsonResource;
use YouHuJun\Tool\App\Facades\V1\Es\EsFacade;

class EsLabelRecource extends JsonResource
{
    /**
     * 指示是否应保留资源的集合原始键。
     *
    ...
    public function toArray($request)
    {
        ...
        $response = [
            ...
            'label_picture_uid' => $this->resource->label_picture_uid,
            'picture' => '',
        ...
        if ($this->resource->label_picture_uid) {
            $pictureIndexName = config('common_es.indices.album.album_pictures');

            $esResult = EsFacade::findDoc($pictureIndexName, $this->resource->label_picture_uid);
