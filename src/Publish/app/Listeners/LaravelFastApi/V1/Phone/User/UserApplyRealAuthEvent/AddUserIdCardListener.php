 ...
 * @LastEditTime: 2025-01-12 15:02:50
 * @FilePath: \app\Listeners\LaravelFastApi\V1\Phone\User\UserApplyRealAuthEvent\AddUserIdCardListener.php
 */

namespace App\Listeners\LaravelFastApi\V1\Phone\User\UserApplyRealAuthEvent;
...
class AddUserIdCardListener
{
    ...
    public function handle(object $event): void
    {
        ...
        $userIdCard = UserIdCard::where('user_uid',$userObject->id)->first();
		...
		$userIdCard->sort = 100;
        $userIdCard->user_uid = $userObject->id;
