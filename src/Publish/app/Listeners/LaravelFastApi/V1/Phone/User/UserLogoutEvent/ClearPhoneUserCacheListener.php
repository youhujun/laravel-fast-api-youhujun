 ...
 * @LastEditTime: 2025-02-22 14:56:49
 * @FilePath: \app\Listeners\LaravelFastApi\V1\Phone\User\UserLogoutEvent\ClearPhoneUserCacheListener.php
 */
...
class ClearPhoneUserCacheListener
{
    ...
    public function handle(object $event): void
    {
        ...
        Redis::hdel("phone_user:user", $userObject->biz_id);
        Redis::hdel("phone_user_info:user_info", $userObject->biz_id);
    }
}
