 ...
 * @LastEditTime: 2025-01-15 16:04:29
 * @FilePath: \app\Listeners\LaravelFastApi\V1\Admin\User\User\AddUserEvent\AddUserQrcodeListener.php
 * Copyright (C) 2025 youhujun. All rights reserved.
 */


namespace App\Listeners\LaravelFastApi\V1\Admin\User\User\AddUserEvent;
...
class AddUserQrcodeListener
{
    ...
    public function handle(object $event): void
    {
        ...
        $albumPicture->user_uid = $userObject->id;
        ...
        $albumPicture->album_uid = $album->id;
        ...
        $userQrcode->user_uid = $userObject->id;
