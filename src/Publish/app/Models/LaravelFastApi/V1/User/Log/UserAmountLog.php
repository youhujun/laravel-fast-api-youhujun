 ...
 * @FilePath: \app\Models\LaravelFastApi\V1\User\Log\UserAmountLog.php
...
class UserAmountLog extends Model
{
     ...
     */
    protected $fillable = [
        'user_amount_log_uid', 'user_uid', 'revision', 'before_amount', 'change_value', 'change_type',
    ...
    // 主键
    protected $primaryKey = 'user_amount_log_uid';
    // 雪花ID非自增
