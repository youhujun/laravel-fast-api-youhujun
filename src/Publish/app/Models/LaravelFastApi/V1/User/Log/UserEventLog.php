 ...
 * @FilePath: \app\Models\LaravelFastApi\V1\User\Log\UserEventLog.php
...
class UserEventLog extends Model
{
     ...
     */
    protected $fillable = [
        'user_event_log_uid','shard_key', 'user_uid', 'revision','data_type', 'event_type', 'event_route_action', 'event_name', 'event_code', 'note', 'created_at', 'created_time', 'updated_at', 'updated_time', 'deleted_at'
    ];
    ...
    // 主键
    protected $primaryKey = 'user_event_log_uid';
    // 雪花ID非自增
