 ...
 * @FilePath: \app\Models\LaravelFastApi\V1\User\Log\UserCoinLog.php
...
class UserCoinLog extends Model
{
     ...
     */
    protected $fillable = [
        'user_coin_log_uid', 'user_uid', 'revision', 'before_amount', 'change_value', 'change_type',
    ...
    // 主键
    protected $primaryKey = 'user_coin_log_uid';
    // 雪花ID非自增
