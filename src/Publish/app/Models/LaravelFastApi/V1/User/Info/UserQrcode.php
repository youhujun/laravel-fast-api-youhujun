 ...
 * @LastEditTime: 2026-04-30 15:17:39
 * @FilePath: \youhu-laravel-api-12\app\Models\LaravelFastApi\V1\User\Info\UserQrcode.php
...
class UserQrcode extends Model
{
     ...
     */
    protected $fillable = [
        'user_qrcode_uid', 'user_uid', 'album_picture_uid', 'revision', 'is_default',
    ...
    // 主键
    protected $primaryKey = 'user_qrcode_uid';
    // 雪花ID非自增
