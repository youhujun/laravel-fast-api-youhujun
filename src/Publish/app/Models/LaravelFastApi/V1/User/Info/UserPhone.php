 ...
 * @FilePath: \app\Models\LaravelFastApi\V1\User\Info\UserPhone.php
...
class UserPhone extends Model
{
     ...
     */
    protected $fillable = [
        'user_phone_uid', 'user_uid', 'revision', 'type', 'is_default', 'phone', 'sort',
    ...
    // 主键
    protected $primaryKey = 'user_phone_uid';
    // 雪花ID非自增
