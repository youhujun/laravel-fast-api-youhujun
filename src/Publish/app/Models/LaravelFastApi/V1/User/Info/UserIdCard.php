 ...
 * @LastEditTime: 2026-04-13 14:47:58
 * @FilePath: \youhu-laravel-api-12\app\Models\LaravelFastApi\V1\User\Info\UserIdCard.php
...
class UserIdCard extends Model
{
     ...
     */
    protected $fillable = [
        'user_id_card_uid', 'user_uid', 'id_card_front_uid', 'id_card_back_uid', 'revision', 'sort',
    ...
    // 表名
    protected $table = 'user_id_cards';
    // 主键
    protected $primaryKey = 'user_id_card_uid';
    // 雪花ID非自增
