 ...
 * @LastEditTime: 2026-03-14 09:02:56
 * @FilePath: \youhu-laravel-api-12\app\Models\LaravelFastApi\V1\User\Info\UserAmount.php
 * Copyright (C) 2026 youhujun. All rights reserved.
 */

namespace App\Models\LaravelFastApi\V1\User\Info;

use Database\Factories\LaravelFastApi\V1\User\UserAmountFactory;
...
class UserAmount extends Model
{
     ...
     */
    protected $fillable = [
        'user_amount_uid', 'user_uid', 'revision', 'amount', 'bonus', 'prepare_bonus', 'coin', 'score',
        'note', 'sort',
    ...
    // 表名
    protected $table = 'user_amounts';
    // 主键
    protected $primaryKey = 'user_amount_uid';
    // 雪花ID非自增
