 ...
 * @Date: 2026-05-17 21:50:36
 * @LastEditors: youhujun youhu8888@163.com & xueer
 * @LastEditTime: 2026-05-18 04:14:13
 * @FilePath: \youhu-laravel-api-12\app\Models\LaravelFastApi\V1\Admin\Info\AdminCascader.php
 * Copyright (C) 2026 youhujun & xueer . All rights reserved.
 */

namespace App\Models\LaravelFastApi\V1\Admin\Info;
...
class AdminCascader extends Model
{
     ...
     */
    protected $fillable = [
        'admin_cascader_uid', 'admin_uid', 'role_cascader_json', 'shard_key','revision','created_at', 'created_time', 'updated_at', 'updated_time','deleted_at'
    ];
     ...
     * 表名
     */
    protected $table = 'admin_cascaders';

	/**
	*主键
	*/
    protected $primaryKey = 'admin_cascader_uid';
