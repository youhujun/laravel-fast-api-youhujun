...
class UploadFileEvent
{
     ...
     * @return void
     */
    public function __construct(Admin $adminObject, array $uploadFileLogDataArray, string $path, string $fileType, string $actionType, int $logDataType = 10)
    {
        $this->adminObject = $adminObject;
        $this->uploadFileLogDataArray = $uploadFileLogDataArray;
        $this->path = $path;
