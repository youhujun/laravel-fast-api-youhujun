...
use App\Http\Resources\LaravelFastApi\V1\Admin\Service\Level\LevelItemResource;
use App\Http\Resources\LaravelFastApi\V1\Admin\Service\Level\UserLevelCollection;
...
class AdminUserLevelFacadeService
{
   ...
   protected static $storage_public_path = DIRECTORY_SEPARATOR.'app'. DIRECTORY_SEPARATOR.'public';
    ...
    public function defaultUserLevel()
    {
        ...
        $result = new SelectUserLevelCollection( $userLevelList,['code'=>0,'msg'=>'获取默认用户级别成功!']);
    ...
    public function findUserLevel($validated)
    {
        ...
        $result = new SelectUserLevelCollection( $userLevelList,['code'=>0,'msg'=>'查找用户级别成功!']);
