   ...
   /**
    ...
    public function updateAdmin($validated, $admin)
    {
        ...
        $updateData = [
            ...
            'updated_time' => time(),
			'role_id'=>json_encode($validated['role']),
    ...
    public function disableAdmin($validated, $admin)
    {
        ...
        $disableAdminUpdateData = ['switch' => $validated['switch'], 'updated_time' => time(), 'updated_at' => \date('Y-m-d H:i:s', time()), 'revision' => $disableAdminRevision + 1];
