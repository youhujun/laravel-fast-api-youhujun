...
use App\Http\Resources\LaravelFastApi\V1\Admin\User\UserRealAuthLogCollection;
...
class AdminUserRealAuthFacadeService
{
   ...
   public function getUserRealAuthApply($validated,$admin)
   {
       ...
       $query = UserRealAuthLog::where($where);
        ...
        {
            $result = new UserRealAuthLogCollection($userApplyRealAuthList,['code'=> 0,'msg'=>'获取用户实名认证申请成功!'],null);
        }
