 ...
 * @LastEditTime: 2025-02-24 17:13:34
 * @FilePath: \database\seeders\LaravelFastApi\System\SystemConfig\SystemConfigSeeder.php
 */
...
class SystemConfigSeeder extends Seeder
{
    ...
    public function run()
    {
         $systemConfigData = [
            ...
            ['item_type'=>40,'item_label'=>'qrcode.logo','item_value'=>'','item_price'=>0,'item_path'=>'config/file/config/default_logo.png','item_introduction'=>'二维码logo','created_time'=>time(),'created_at'=>date('Y-m-d H:i:s',time()),'sort'=>100],
