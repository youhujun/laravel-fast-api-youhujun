 ...
 * @LastEditTime: 2026-02-10 04:20:53
...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->command->info('开始填后台菜单');
        $this->runOneDeepData();
        $this->runTwoDeepData();
        $this->runThreeDeepData();
        $this->command->info('✅填后台菜单填充完成');
    }
    ...
    protected function runOneDeepData()
    {
        ...
        DB::connection($dbConnection)->table('permissions')->insert($oneDeepData);
    }
    ...
    protected function runTwoDeepData()
    {
        ...
        DB::connection($dbConnection)->table('permissions')->insert($twoDeepData);
    }
    ...
    protected function runThreeDeepData()
    {
        ...
        DB::connection($dbConnection)->table('permissions')->insert($threeDeepData);
    }
}
