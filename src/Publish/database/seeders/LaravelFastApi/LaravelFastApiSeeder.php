 ...
 * @LastEditTime: 2026-05-18 01:30:47
 * @FilePath: \youhu-laravel-api-12\database\seeders\LaravelFastApi\LaravelFastApiSeeder.php
...
//|--|--分类管理
//|--|--|--文章分类
use Database\Seeders\LaravelFastApi\Service\Group\ArticleCategory\CategorySeeder;
//|--|--级别管理
//|--|--|--|级别配置项
use Database\Seeders\LaravelFastApi\Service\Level\LevelItemSeeder;
//|--|--|--|级别管理
use Database\Seeders\LaravelFastApi\Service\Level\UserLevelSeeder;
//|--|--|--|++建立级别和级别的关系
...
//|--|--用户头像
use Database\Seeders\LaravelFastApi\User\UserAvatarSeeder;
//|--|--|++用户角色处理
use Database\Seeders\LaravelFastApi\User\Role\UserRoleUnionSeeder;
use Database\Seeders\LaravelFastApi\User\Role\UserCascaderSeeder;
//|--|--|++用户账户
use Database\Seeders\LaravelFastApi\User\UserAmountSeeder;
//|--|--管理员管理
use Database\Seeders\LaravelFastApi\Admin\AdminSeeder;
use Database\Seeders\LaravelFastApi\Admin\Role\AdminCascaderSeeder;
//|--|--用户授权
use Database\Seeders\LaravelFastApi\Auth\YouhuAuthServiceSeeder;
//|--|--|++用户来源关系
use Database\Seeders\LaravelFastApi\User\Union\UserSourceUnionSeeder;
    ...
    public function run(): void
    {
        ...
        $this->call(
            [
                ...
                UserCascaderSeeder::class,
                //|--|--|++用户账户
                UserAmountSeeder::class,
                //|--|--管理员管理
                AdminSeeder::class,
                AdminCascaderSeeder::class,
                //用户授权
                YouhuAuthServiceSeeder::class,
                //|--|--|++用户来源关系
                UserSourceUnionSeeder::class,
            ]
        );
