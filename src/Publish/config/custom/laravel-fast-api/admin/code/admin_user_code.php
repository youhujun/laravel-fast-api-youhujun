 ...
 * @LastEditTime: 2026-05-20 03:03:18
 * @FilePath: \youhu-laravel-api-12\config\custom\laravel-fast-api\admin\code\admin_user_code.php
 */

 $adminCodeArray = [
	'UpdateAdminPhoneError'=>[ 'code'=>10000, 'msg'=>'更新收手机号失败','error'=>'UpdateAdminPhoneError' ],
	'UpdateAdminPasswordError'=>[ 'code'=>10000, 'msg'=>'更新收密码失败','error'=>'UpdateAdminPasswordError' ],
	'AdminPasswordNotSameError'=>[ 'code'=>10000, 'msg'=>'密码不一致','error'=>'AdminPasswordNotSameError' ],
    ...
    //删除管理员
    'DeleteSystemAdminError'=>[ 'code'=>10000, 'msg'=>'系统管理员不可以删除','error'=>'DeleteSystemAdminError' ],
 ...
 $userCodeArray =  [
    //|--|--|--用户管理
		...
		//用户三级分销
		'SaveUserSourceError'=>[ 'code'=>10000, 'msg'=>'保存用户上级失败!','error'=>'AddUserEventError' ],
		'AddUserSourceUnionError'=>[ 'code'=>10000, 'msg'=>'添加用户级别关联失败!','error'=>'AddUserSourceUnionError' ],
		'SaveUserParentError'=>[ 'code'=>10000, 'msg'=>'保存用户系统上级失败!','error'=>'SaveUserParentError' ],
		'AddUserSourceError'=>[ 'code'=>10000, 'msg'=>'添加用户上级失败!','error'=>'AddUserSourceError' ],
        //详情
        'AddUserInfoError'=>[ 'code'=>10000, 'msg'=>'添加用户详情失败','error'=>'AddUserInfoError' ],
		//用户账户
        'AddUserAmountError'=>[ 'code'=>10000, 'msg'=>'添加用户账户失败','error'=>'AddUserAmountError' ],
        //用户相册
