 ...
 * @LastEditTime: 2026-05-20 12:37:25
 * @FilePath: \youhu-laravel-api-12\config\custom\laravel-fast-api\admin\code\admin_code.php
 */
...
$systemCodeArray = [
    ...
    'ServiceBusyError' => ['code' => 10000, 'msg' => '服务繁忙!','error' => 'ServiceBusyError'],
    ...
    //更新检测唯一性失败
    'UpdatePropertyUniqueError' => ['code' => 10000, 'msg' => '更新检测唯一性失败','error' => 'UpdatePropertyUniqueError'],

    //用户修改删除数据时候,先查询不存在
    'ThisDataNotExistsError' => ['code' => 10000,'msg' => '该数据不存在!','error' => 'ThisDataNotExistsError'],
    'ThatDataNotExistError' => ['code' => 10000,'msg' => '该数据不存在!','error' => 'ThatDataNotExistError'],

    //父级数据不存在
    'ThisParentDataNotExistsError' => ['code' => 10000,'msg' => '上级该数据不存在!','error' => 'ThisParentDataNotExistsError'],


    'ThisDataPropertyNotExistsError' => ['code' => 10000,'msg' => '该数据不存在该属性!','error' => 'ThisDataPropertyNotExistsError'],

    'ThisDataPropertyNoAllowError' => ['code' => 10000,'msg' => '该数据非法!','error' => 'ThisDataPropertyNoAllowError'],

    //有子级数据
    'ThisDataHasChildrenError' => ['code' => 10000,'msg' => '该数据有子级存在!','error' => 'ThisDataHasChildrenError'],
    'UploadFileTypeError' => ['code' => 10000,'msg' => '上传文件格式不对!','error' => 'UploadFileTypeError'],
