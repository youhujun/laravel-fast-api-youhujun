...
return [
	...
	//|--|--三方平台
		// 微信平台
		'AddSystemWechatConfigError'=>[ 'code'=>10000, 'msg'=>'添加系统微信配置失败','errot'=>'AddSystemWechatConfigError' ],
        'UpdateSystemWechatConfigError'=>[ 'code'=>10000, 'msg'=>'修改系统微信配置失败','errot'=>'AddSystemWechatConfigError' ],
        'DeleteSystemWechatConfigError'=>[ 'code'=>10000, 'msg'=>'删除系统微信配置失败','errot'=>'DeleteSystemWechatConfigError' ],
        'MultipleDeleteSystemWechatConfigError'=>[ 'code'=>10000, 'msg'=>'批量删除系统微信配置失败','errot'=>'DeleteSystemWechatConfigError' ],
		// 抖音平台
		'AddSystemDouyinConfigError'=>[ 'code'=>10000, 'msg'=>'添加系统抖音配置失败','errot'=>'AddSystemDouyinConfigError' ],
        'UpdateSystemDouyinConfigError'=>[ 'code'=>10000, 'msg'=>'修改系统抖音配置失败','errot'=>'AddSystemDouyinConfigError' ],
        'DeleteSystemDouyinConfigError'=>[ 'code'=>10000, 'msg'=>'删除系统抖音配置失败','errot'=>'DeleteSystemDouyinConfigError' ],
        'MultipleDeleteSystemDouyinConfigError'=>[ 'code'=>10000, 'msg'=>'批量删除系统抖音配置失败','errot'=>'DeleteSystemDouyinConfigError' ],
    //|--|--|--首页轮播
    //获取轮播图
