 ...
 * @LastEditTime: 2025-12-08 14:57:12
 * @FilePath: \config\custom\laravel-fast-api\admin\event\admin_user_event.php
 */
$adminCodeArray = [
	'UpdateAdminPhone'=>[ 'code' => 10000, 'info' => '更新管理员手机号','event'=>'UpdateAdminPhone' ],
	'UpdateAdminPassword'=>[ 'code' => 10000, 'info' => '更新管理员手机号','event'=>'UpdateAdminPassword' ],
     //|--|--管理员管理
...
$userCodeArray = [
     ...
     //|--|--用户管理
        ...
        //|--|--|++用户账户
        'SetUserAccount' => [ 'code' => 10000, 'info' => '后台修改用户金额','event'=>'SetUserAccount' ],
		//|--|--|++用户二维码	
        'MakeUserQrcode' => [ 'code' => 10000, 'info' => '后台生成用户二维码','event'=>'MakeUserQrcode' ],
	];
