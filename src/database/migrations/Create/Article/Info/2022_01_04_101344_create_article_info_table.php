...
return new class extends Migration
{
    ...
    public function up()
    {
		...
		//注意是否需要修改mysql连接名和表名
		if (!Schema::connection($db_connection)->hasTable('article_info')) 
		{
			Schema::connection($db_connection)->create('article_info', function (Blueprint $table) {
        ...
        DB::connection($db_connection)->statement("ALTER TABLE `{$prefix}article_info` comment '文章详情表'");
    ...
    public function down()
    {
		...
		if (Schema::connection($db_connection)->hasTable('article_info')) 
		{
			Schema::connection($db_connection)->dropIfExists('article_info');
		}
