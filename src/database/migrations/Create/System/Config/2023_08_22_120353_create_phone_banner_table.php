...
return new class extends Migration
{
    ...
    public function up()
    {
		...
		if (!Schema::connection($db_connection)->hasTable('phone_banner')) 
		{
			Schema::connection($db_connection)->create('phone_banner', function (Blueprint $table)
			{
			...
			DB::connection($db_connection)->statement("ALTER TABLE `{$prefix}phone_banner` comment '手机轮播图'");
		}
    ...
    public function down()
    {
		...
		if (Schema::connection($db_connection)->hasTable('phone_banner')) 
		{
			Schema::connection($db_connection)->dropIfExists('phone_banner');
		}
