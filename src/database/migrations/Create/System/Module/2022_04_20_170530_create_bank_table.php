...
return new class extends Migration
{
    ...
    public function up()
    {
		...
		if (!Schema::connection($db_connection)->hasTable('bank')) 
		{
			Schema::connection($db_connection)->create('bank', function (Blueprint $table) {
			...
			DB::connection($db_connection)->statement("ALTER TABLE `{$prefix}bank` comment '系统银行表'");
		}
    ...
    public function down()
    {
		...
		if (Schema::connection($db_connection)->hasTable('bank')) 
		{
			Schema::connection($db_connection)->dropIfExists('bank');
		}
