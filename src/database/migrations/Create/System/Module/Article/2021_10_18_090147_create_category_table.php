...
return new class extends Migration
{
    ...
    public function up()
    {
		...
		if (!Schema::connection($db_connection)->hasTable('category')) 
		{
			Schema::connection($db_connection)->create('category', function (Blueprint $table) {
			 ...
			 DB::connection($db_connection)->statement("ALTER TABLE `{$prefix}category` comment '文章分类表'");
		}
    ...
    public function down()
    {
		...
		if (Schema::connection($db_connection)->hasTable('category')) 
		{
			Schema::connection($db_connection)->dropIfExists('category');
		}
