...
return new class extends Migration
{
    ...
    public function up()
    {
		...
		if (!Schema::connection($db_connection)->hasTable('region')) 
		{
			Schema::connection($db_connection)->create('region', function (Blueprint $table) {
			...
			DB::connection($db_connection)->statement("ALTER TABLE `{$prefix}region` comment '系统地区表'");
		}
    ...
    public function down()
    {
		...
		if (Schema::connection($db_connection)->hasTable('region')) 
		{
			Schema::connection($db_connection)->dropIfExists('region');
		}
