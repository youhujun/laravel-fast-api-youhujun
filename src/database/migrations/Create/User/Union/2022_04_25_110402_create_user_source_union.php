...
return new class extends Migration
{
    ...
    public function up()
    {
		...
		{
			Schema::connection($db_connection)->create('user_source_union', function (Blueprint $table) {
			...
			DB::connection($db_connection)->statement("ALTER TABLE `{$prefix}user_source_union` comment '用户父关联表'");
		}
    ...
    public function down()
    {
		...
		if (Schema::connection($db_connection)->hasTable('user_source_union')) 
		{
			Schema::connection($db_connection)->dropIfExists('user_source_union');
		}
