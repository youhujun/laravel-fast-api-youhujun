...
return new class extends Migration
{
    ...
    public function up()
    {
		...
		{
			Schema::connection($db_connection)->create('user_role_union', function (Blueprint $table) {
			...
			DB::connection($db_connection)->statement("ALTER TABLE `{$prefix}user_role_union` comment '用户和角色关联表'");
		}
    ...
    public function down()
    {
		...
		if (Schema::connection($db_connection)->hasTable('user_role_union')) 
		{
			Schema::connection($db_connection)->dropIfExists('user_role_union');
		}
