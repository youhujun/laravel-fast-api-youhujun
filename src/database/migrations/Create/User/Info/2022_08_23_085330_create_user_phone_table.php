...
return new class extends Migration
{
    ...
    public function up()
    {
		...
		if (!Schema::connection($db_connection)->hasTable('user_phone')) 
		{
			Schema::connection($db_connection)->create('user_phone', function (Blueprint $table) {
				$table->id()->comment('主键');
			...
			DB::connection($db_connection)->statement("ALTER TABLE `{$prefix}user_phone` comment '用户联系电话表'");
		}
    ...
    public function down()
    {
		...
		if (Schema::connection($db_connection)->hasTable('user_phone')) 
		{
			Schema::connection($db_connection)->dropIfExists('user_phone');
		}
