...
return new class extends Migration
{
    ...
    public function up()
    {
		...
		if (!Schema::connection($db_connection)->hasTable('user_bank')) 
		{
			Schema::connection($db_connection)->create('user_bank', function (Blueprint $table) {
			 ...
			 DB::connection($db_connection)->statement("ALTER TABLE `{$prefix}user_bank` comment '用户银行信息表'");
		}
    ...
    public function down()
    {
		...
		if (Schema::connection($db_connection)->hasTable('user_bank')) 
		{
			Schema::connection($db_connection)->dropIfExists('user_bank');
		}
