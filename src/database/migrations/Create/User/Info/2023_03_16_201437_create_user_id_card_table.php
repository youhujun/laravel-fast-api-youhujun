...
return new class extends Migration
{
    ...
    public function up()
    {
		...
		if (!Schema::connection($db_connection)->hasTable('user_id_card')) 
		{
			Schema::connection($db_connection)->create('user_id_card', function (Blueprint $table) 
			{
				$table->id()->comment('主键');
			...
			DB::connection($db_connection)->statement("ALTER TABLE `{$prefix}user_id_card` comment '用户身份证表'");
		}
    ...
    public function down()
    {
		...
		if (Schema::connection($db_connection)->hasTable('user_id_card')) 
		{
			Schema::connection($db_connection)->dropIfExists('user_id_card');
		}
