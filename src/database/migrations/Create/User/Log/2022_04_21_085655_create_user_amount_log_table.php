 ...
 * @LastEditTime: 2025-12-03 10:08:14
 */
...
return new class extends Migration
{
    ...
    public function up()
    {
		...
		if (!Schema::connection($db_connection)->hasTable('user_amount_log')) 
		{
			Schema::connection($db_connection)->create('user_amount_log', function (Blueprint $table) {
			...
			DB::connection($db_connection)->statement("ALTER TABLE `{$prefix}user_amount_log` comment '用户余额日志表'");
		}
    ...
    public function down()
    {
		...
		if (Schema::connection($db_connection)->hasTable('user_amount_log')) 
		{
			Schema::connection($db_connection)->dropIfExists('user_amount_log');
		}
