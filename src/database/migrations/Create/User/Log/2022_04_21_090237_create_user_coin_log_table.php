 ...
 * @LastEditTime: 2025-01-07 10:45:03
 */
...
return new class extends Migration
{
    ...
    public function up()
    {
		...
		if (!Schema::connection($db_connection)->hasTable('user_coin_log')) 
		{
			Schema::connection($db_connection)->create('user_coin_log', function (Blueprint $table) {
			...
			DB::connection($db_connection)->statement("ALTER TABLE `{$prefix}user_coin_log` comment '用户系统币日志表'");
		}
    ...
    public function down()
    {
		...
		if (Schema::connection($db_connection)->hasTable('user_coin_log')) 
		{
			Schema::connection($db_connection)->dropIfExists('user_coin_log');
		}
